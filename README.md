...
| [`docs/NEXT-SPRINT.md`](docs/NEXT-SPRINT.md) | Bounded release documentation correction and subprocess process-group signal repair. | 2026-09-17 | A stage replaces it with its contract: a qualification stage through a dedicated planning change, any other stage in the first commit of its own pull request. |
