...
| [`ROADMAP.md`](ROADMAP.md) | Detailed dependency-ordered path to a narrow, exact, robust, documented, and obtainable 1.0 release. | 2026-09-02 | Product targets, milestone order, release acceptance, package platforms, compatibility boundary, or exclusions change. |
...
| [`docs/NEXT-SPRINT.md`](docs/NEXT-SPRINT.md) | Active product contract for Lua 5.1 integral-number constants: outcome, allowed paths, evidence, non-goals, and stop condition. | 2026-09-02 | The integral-number evidence is accepted, or a dedicated planning change replaces it with one unmet outcome and its evidence and stop boundary. |
