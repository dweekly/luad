...
|---|---:|---|---|
| Lua 5.1 | 38 | Yes | Experimental; public layout, profile, disassembly, reference-operand and register-`A` validation, closure identity, query, and machine-interface evidence exists; exact target promotion remains pending |
