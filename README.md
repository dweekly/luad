...
| [`docs/NEXT-SPRINT.md`](docs/NEXT-SPRINT.md) | Release contract: prepare, verify, and publish experimental luad 0.2.0. | 2026-09-17 | A stage replaces it with its contract: a qualification stage through a dedicated planning change, any other stage in the first commit of its own pull request. |
