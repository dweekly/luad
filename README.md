...
| [`docs/NEXT-SPRINT.md`](docs/NEXT-SPRINT.md) | Active sprint contract: constant-key table-literal origins (R-1a) emitting table-literal expressions. | 2026-09-18 | The sprint completes, is accepted or rejected, or its scope or evidence boundary changes. |
