...
| [`docs/NEXT-SPRINT.md`](docs/NEXT-SPRINT.md) | Active Milestone 1 contract to declare and execute-test Rust 1.85 as the stable workspace MSRV without changing contributor, release, or fuzz toolchain pins. | 2026-08-27 | The MSRV contract is accepted or replaced; return it to the neutral checkpoint before selecting another roadmap outcome. |
