...
| [`docs/NEXT-SPRINT.md`](docs/NEXT-SPRINT.md) | Active Milestone 1 contract to gate the exact locked dependency graph against approved licenses and current RustSec advisories. | 2026-08-27 | The dependency-audit contract is accepted or replaced; return it to the neutral checkpoint before selecting another roadmap outcome. |
