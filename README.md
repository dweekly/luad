...
| [`docs/NEXT-SPRINT.md`](docs/NEXT-SPRINT.md) | Active sprint contract: CFG alternatives for bounded definitions (R-1b) emitting alternatives expressions. | 2026-09-18 | The sprint completes, is accepted or rejected, or its scope or evidence boundary changes. |
