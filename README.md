...
| [`docs/NEXT-SPRINT.md`](docs/NEXT-SPRINT.md) | Active sprint contract: Corpus-wide query --input-list (R-4) with streaming JSONL framing. | 2026-09-18 | The sprint completes, is accepted or rejected, or its scope or evidence boundary changes. |
