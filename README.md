...
Area 1 validator-and-diagnostic gate. Exact Lua 5.1 target promotion remains roadmap
work.
...
|---|---:|---|---|
| Lua 5.1 | 38 | Yes | Experimental; validator and diagnostic authority closes over public profile, operand, span, prototype-identity, catalog, and firmware-shaped stress evidence; exact target promotion remains pending |
