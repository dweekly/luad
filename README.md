...
queries, and machine output have named experimental public-boundary gates. Exact Lua
5.1 target promotion remains roadmap work.
...
|---|---|---:|---|
| [`README.md`](README.md) | Project status, entry points, documentation index, build, and first-use commands. | 2026-08-23 | Public scope, support status, setup, primary commands, or the documentation set changes. |
...
| [`CHANGELOG.md`](CHANGELOG.md) | Backward-facing record of unreleased and released user-visible changes. | 2026-08-23 | Every user-visible change or release; never use it as a forward plan. |
...
|---|---:|---|---|
| Lua 5.1 | 38 | Yes | Experimental; public layout, profile, disassembly, reference-operand validation, closure identity, query, and machine-interface evidence exists; exact target promotion remains pending |
