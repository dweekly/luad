...
Area 1 validator-and-diagnostic gate. The OpenWrt-derived Lua 5.1.5 LNUM32 compiler
authority is publicly reproducible; exact target promotion remains pending.
...
|---|---:|---|---|
| Lua 5.1 | 38 | Yes | Experimental; public LNUM32 compiler authority plus validator and diagnostic evidence exists; exact target promotion remains pending |
