...
| [`docs/NEXT-SPRINT.md`](docs/NEXT-SPRINT.md) | Active release-infrastructure contract for independently repeated hosted builds of both planned release-platform archives. | 2026-08-27 | Replace with the neutral checkpoint when both two-replica platform builds, byte comparisons, combined checksums, corruption probe, diagnostic bundle, and documentation close, or revise before implementation if that boundary changes. |
