...
fn lift_instruction_52(
    ...
    match op {
        Opcode52::Move => {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1130".to_string());
        }
        Opcode52::LoadK => {
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1135".to_string());
        }
        Opcode52::LoadKx => {
            operands.push(TypedOperand::Register { index: raw.a });
            writes.push(EffectTarget::Register { index: raw.a });
            explanation = format!("Load extra-arg constant into R({})", raw.a);
            citations.push("lua-5.2.4:src/lvm.c:1140".to_string());
        }
        Opcode52::LoadBool => {
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1145".to_string());
        }
        Opcode52::LoadNil => {
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1150".to_string());
        }
        Opcode52::GetUpval => {
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1155".to_string());
        }
        Opcode52::GetTabUp => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Upvalue {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1160".to_string());
        }
        Opcode52::GetTable => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Register { index: raw.b as u8 });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1170".to_string());
        }
        Opcode52::SetTabUp => {
            operands.push(TypedOperand::Upvalue {
                index: raw.a,
            ...
            citations.push("lua-5.2.4:src/lvm.c:1180".to_string());
        }
        Opcode52::SetUpval => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Upvalue {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1190".to_string());
        }
        Opcode52::SetTable => {
            operands.push(TypedOperand::Register { index: raw.a });
            reads.push(EffectTarget::Register { index: raw.a });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1200".to_string());
        }
        Opcode52::NewTable => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1210".to_string());
        }
        Opcode52::SelfOp => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Register { index: raw.b as u8 });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1220".to_string());
        }
        Opcode52::Add
        | Opcode52::Sub
        | Opcode52::Mul
        ...
        | Opcode52::Pow => {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1230".to_string());
        }
        Opcode52::Unm | Opcode52::Not | Opcode52::Len => {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1260".to_string());
        }
        Opcode52::Concat => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Register { index: raw.b as u8 });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1270".to_string());
        }
        Opcode52::Jmp => {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1280".to_string());
        }
        Opcode52::Eq | Opcode52::Lt | Opcode52::Le => {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1290".to_string());
        }
        Opcode52::Test => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Flag { value: raw.c != 0 });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1300".to_string());
        }
        Opcode52::TestSet => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Register { index: raw.b as u8 });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1310".to_string());
        }
        Opcode52::Call => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1320".to_string());
        }
        Opcode52::TailCall => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1330".to_string());
        }
        Opcode52::Return => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1340".to_string());
        }
        Opcode52::ForLoop => {
            let target = (pc as i32 + 1 + raw.sbx) as usize;
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1350".to_string());
        }
        Opcode52::ForPrep => {
            let target = (pc as i32 + 1 + raw.sbx) as usize;
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1360".to_string());
        }
        Opcode52::TForCall => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1370".to_string());
        }
        Opcode52::TForLoop => {
            let target = (pc as i32 + 1 + raw.sbx) as usize;
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1380".to_string());
        }
        Opcode52::SetList => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1390".to_string());
        }
        Opcode52::Closure => {
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.2.4:src/lvm.c:1400".to_string());
        }
        Opcode52::VarArg => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.2.4:src/lvm.c:1410".to_string());
        }
        Opcode52::ExtraArg => {
            operands.push(TypedOperand::ExtraArg { value: raw.ax });
            explanation = format!("Extra argument: {}", raw.ax);
            citations.push("lua-5.2.4:src/lvm.c:1420".to_string());
        }
    }
