//! Semantic lifter for Lua 5.3 bytecode.
...
#[must_use]
pub fn lift_proto_lua53(proto: &Prototype) -> Vec<SemanticInstruction> {
    ...
    for (pc, inst) in proto.instructions.iter().enumerate() {
        ...
        let next_word = proto
            .instructions
            .get(pc + 1)
            .map(|i| RawInstruction53::decode(i.raw_word));
        ...
        let semantic = lift_instruction_53(proto, pc, inst, raw, next_word, prev_word);
...
fn lift_instruction_53(
    proto: &Prototype,
    pc: usize,
    inst: &luad_core::model::InstructionWord,
    raw: RawInstruction53,
    _next: Option<RawInstruction53>,
    _prev: Option<RawInstruction53>,
) -> SemanticInstruction {
    ...
    match op {
        Opcode53::Move => {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1130".to_string());
        }
        Opcode53::LoadK => {
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1135".to_string());
        }
        Opcode53::LoadKx => {
            operands.push(TypedOperand::Register { index: raw.a });
            writes.push(EffectTarget::Register { index: raw.a });
            explanation = format!("Load extra-arg constant into R({})", raw.a);
            citations.push("lua-5.3.6:src/lvm.c:1140".to_string());
        }
        Opcode53::LoadBool => {
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1145".to_string());
        }
        Opcode53::LoadNil => {
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1150".to_string());
        }
        Opcode53::GetUpval => {
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1155".to_string());
        }
        Opcode53::GetTabUp => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Upvalue {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1160".to_string());
        }
        Opcode53::GetTable => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Register { index: raw.b as u8 });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1170".to_string());
        }
        Opcode53::SetTabUp => {
            operands.push(TypedOperand::Upvalue {
                index: raw.a,
            ...
            citations.push("lua-5.3.6:src/lvm.c:1180".to_string());
        }
        Opcode53::SetUpval => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Upvalue {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1190".to_string());
        }
        Opcode53::SetTable => {
            operands.push(TypedOperand::Register { index: raw.a });
            reads.push(EffectTarget::Register { index: raw.a });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1200".to_string());
        }
        Opcode53::NewTable => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1210".to_string());
        }
        Opcode53::SelfOp => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Register { index: raw.b as u8 });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1220".to_string());
        }
        Opcode53::Add
        | Opcode53::Sub
        | Opcode53::Mul
        ...
        | Opcode53::Shr => {
            ...
            let mm = match op {
                ...
                Opcode53::Pow => "__pow",
                Opcode53::Div => "__div",
                Opcode53::IDiv => "__idiv",
                Opcode53::BAnd => "__band",
                Opcode53::BOr => "__bor",
                Opcode53::BXor => "__bxor",
                Opcode53::Shl => "__shl",
                Opcode53::Shr => "__shr",
                _ => "__add",
            };
            ...
            citations.push("lua-5.3.6:src/lvm.c:1230".to_string());
        }
        Opcode53::Unm | Opcode53::BNot | Opcode53::Not | Opcode53::Len => {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1260".to_string());
        }
        Opcode53::Concat => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Register { index: raw.b as u8 });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1270".to_string());
        }
        Opcode53::Jmp => {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1280".to_string());
        }
        Opcode53::Eq | Opcode53::Lt | Opcode53::Le => {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1290".to_string());
        }
        Opcode53::Test => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Flag { value: raw.c != 0 });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1300".to_string());
        }
        Opcode53::TestSet => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Register { index: raw.b as u8 });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1310".to_string());
        }
        Opcode53::Call => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1320".to_string());
        }
        Opcode53::TailCall => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1330".to_string());
        }
        Opcode53::Return => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1340".to_string());
        }
        Opcode53::ForLoop => {
            let target = (pc as i32 + 1 + raw.sbx) as usize;
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1350".to_string());
        }
        Opcode53::ForPrep => {
            let target = (pc as i32 + 1 + raw.sbx) as usize;
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1360".to_string());
        }
        Opcode53::TForCall => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1370".to_string());
        }
        Opcode53::TForLoop => {
            let target = (pc as i32 + 1 + raw.sbx) as usize;
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1380".to_string());
        }
        Opcode53::SetList => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1390".to_string());
        }
        Opcode53::Closure => {
            operands.push(TypedOperand::Register { index: raw.a });
            ...
            citations.push("lua-5.3.6:src/lvm.c:1400".to_string());
        }
        Opcode53::VarArg => {
            operands.push(TypedOperand::Register { index: raw.a });
            operands.push(TypedOperand::Count {
            ...
            citations.push("lua-5.3.6:src/lvm.c:1410".to_string());
        }
        Opcode53::ExtraArg => {
            operands.push(TypedOperand::ExtraArg { value: raw.ax });
            explanation = format!("Extra argument: {}", raw.ax);
            citations.push("lua-5.3.6:src/lvm.c:1420".to_string());
        }
    }
