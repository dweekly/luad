...
pub fn decode_chunk_lua51(reader: &mut SafeReader) -> Result<Chunk, Diagnostic> {
    ...
    let main_proto = load_proto_51(reader, &header, &ProtoPath::root(), None)?;
    ...
    validate_chunk_lua51(&mut chunk);
...
fn load_proto_51(
    ...
    for child_idx in 0..sizep {
        ...
        let child_proto = load_proto_51(&mut child_guard, header, &child_path, source_name.as_ref())?;
