...
fn test_all_fixtures_lua53_parsing_and_truncation() {
    ...
    for fixture_name in fixture_names {
        ...
        let chunk_debug = luad_dialect_lua53::decode_chunk_lua53(&mut reader_debug)
        ...
        let raw_stripped = get_fixture_bytes("lua5.3", fixture_name, true)
        ...
        let chunk_stripped = luad_dialect_lua53::decode_chunk_lua53(&mut reader_stripped)
