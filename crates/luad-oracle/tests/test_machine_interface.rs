...
fn test_schema_goldens_consistency() {
    ...
    let goldens = [
        ...
        ("callgraph", "callgraph.schema.json"),
        ("origins", "origins.schema.json"),
...
fn test_every_single_input_jsonl_fact_is_self_identifying() {
    ...
    let commands = vec![
        ...
        vec!["callgraph".to_string(), lua51.display().to_string()],
        vec!["origins".to_string(), lua51.display().to_string()],
...
fn test_validate_all_generated_examples_against_schemas() {
    ...
    let examples = [
        ...
        ("callgraph.json", "callgraph.schema.json"),
        ("origins.json", "origins.schema.json"),
